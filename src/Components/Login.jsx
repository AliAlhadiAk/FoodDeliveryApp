...
const Login = () => {
  return (
    <div className='fixed top-0 left-0 w-full h-full flex justify-center items-center'>
      <div className='bg-white p-8 relative rounded-lg shadow-lg max-w-md w-full  shadow-2xl'>
        ...
        <p className='mt-4 text-sm text-gray-600 text-center'>
          Already have an account? <Link to={'/signup'}  className='text-orange-500'>Sign In</Link>
        </p>
      </div>
    </div>
  );
